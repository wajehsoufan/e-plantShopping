...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to eParadise Nursery, where green meets serenity!</p>
      <p className="about-us-content">
        At eParadise Nursery, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
      ...
      <p className="about-us-content">
        Our team of experts ensure that plants meet our strict standards of quality and care. 
        Whether you're a gardener or starting your green journey, we're here to support you every step of 
